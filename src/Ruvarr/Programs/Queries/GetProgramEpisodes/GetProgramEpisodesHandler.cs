        ...
        => dbContext.Set<RuvEpisode>()
            ...
            .Select(x => new EpisodeSummary(
                ...
                x.TvdbEpisodes.OrderBy(e => e.SeasonNumber).ThenBy(e => e.EpisodeNumber)
                    .Select(e => new TvdbEpisodeSummary(e.TvdbId, e.SeasonNumber, e.EpisodeNumber, e.IsMissing, e.HasIslTranslation, new Uri($"https://www.thetvdb.com/episodes/{e.TvdbId}")))
                    .ToList(),
                x.FirstRun,
